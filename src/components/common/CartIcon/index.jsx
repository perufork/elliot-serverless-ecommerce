...
const CartIcon = ({ size = 16, color = "#222" }) => (
	<svg
		version="1.1"
		id="elliot-checkout-icon"
...
export const GridIcon = ({ color, onClick }) => (
	<svg
		onClick={onClick}
		width="35px"
		height="35px"
	...
	>
		...
		>
			<g
				id="Two-products-in-Cart"
				transform="translate(-190.000000, -16.000000)"
				fill={color}
			>
				<g id="Group-2" transform="translate(190.000000, 16.000000)">
